...
// Iconly Bold / Chat — 1:1 port from Figma node I4:10455 (the FAB icon).
// Single white path with negative-space cutouts for the three dots.
export function ChatFabIcon({ size = 24, color = '#FFFFFF' }: Props) {
  return (
    <Svg
      width={size}
      height={size}
